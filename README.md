# 📋 Aplicação — Listar Tarefas
 
Bem-vindo ao repositório da aplicação **Listar Tarefas** 🚀
...
- Praticar JavaScript na manipulação de tarefas
- Trabalhar conceitos de organização visual
- Aprender estruturação com HTML e CSS
